...
pub export fn heapinsert(arg_h: [*c]Heap, arg_x: ?*anyopaque) c_int {
    var h = arg_h;
    _ = &h;
    var x = arg_x;
    _ = &x;
    if (h.*.len == h.*.cap) {
        var ndata: [*c]?*anyopaque = undefined;
        _ = &ndata;
        var ncap: usize = (h.*.len +% @as(usize, @bitCast(@as(c_long, @as(c_int, 1))))) *% @as(usize, @bitCast(@as(c_long, @as(c_int, 2))));
        _ = &ncap;
        ndata = @as([*c]?*anyopaque, @ptrCast(@alignCast(malloc(@sizeOf(?*anyopaque) *% ncap))));
        if (!(ndata != null)) {
            return 0;
        }
        _ = memcpy(@as(?*anyopaque, @ptrCast(ndata)), @as(?*const anyopaque, @ptrCast(h.*.data)), @sizeOf(?*anyopaque) *% h.*.len);
...
pub export fn heapremove(arg_h: [*c]Heap, arg_k: usize) ?*anyopaque {
    var h = arg_h;
    _ = &h;
    var k = arg_k;
    _ = &k;
...
pub fn set(arg_h: [*c]Heap, arg_k: usize, arg_x: ?*anyopaque) callconv(.C) void {
    var h = arg_h;
    _ = &h;
    var k = arg_k;
    _ = &k;
...
pub fn swap(arg_h: [*c]Heap, arg_a: usize, arg_b: usize) callconv(.C) void {
    var h = arg_h;
    _ = &h;
    var a = arg_a;
    _ = &a;
...
pub fn less(arg_h: [*c]Heap, arg_a: usize, arg_b: usize) callconv(.C) c_int {
    var h = arg_h;
    _ = &h;
    var a = arg_a;
    _ = &a;
...
pub fn siftdown(arg_h: [*c]Heap, arg_k: usize) callconv(.C) void {
    var h = arg_h;
    _ = &h;
    var k = arg_k;
    _ = &k;
    while (true) {
        var p: usize = (k -% @as(usize, @bitCast(@as(c_long, @as(c_int, 1))))) / @as(usize, @bitCast(@as(c_long, @as(c_int, 2))));
        _ = &p;
        if ((k == @as(usize, @bitCast(@as(c_long, @as(c_int, 0))))) or (less(h, p, k) != 0)) {
            return;
        }
        swap(h, k, p);
        k = p;
...
pub fn siftup(arg_h: [*c]Heap, arg_k: usize) callconv(.C) void {
    var h = arg_h;
    _ = &h;
    var k = arg_k;
    _ = &k;
    while (true) {
        var l: usize = (k *% @as(usize, @bitCast(@as(c_long, @as(c_int, 2))))) +% @as(usize, @bitCast(@as(c_long, @as(c_int, 1))));
        _ = &l;
        var r: usize = (k *% @as(usize, @bitCast(@as(c_long, @as(c_int, 2))))) +% @as(usize, @bitCast(@as(c_long, @as(c_int, 2))));
        _ = &r;
        var s: usize = k;
        _ = &s;
        if ((l < h.*.len) and (less(h, l, s) != 0)) {
            s = l;
        }
        if ((r < h.*.len) and (less(h, r, s) != 0)) {
            s = r;
        }
        if (s == k) {
            return;
...
pub inline fn __FDS_BITS(set_1: anytype) @TypeOf(set_1.*.__fds_bits) {
    _ = &set_1;
    return set_1.*.__fds_bits;
}
