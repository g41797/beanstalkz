...
// src/submodules/beanstalkd/util.c:31:1: warning: TODO unable to translate variadic function, demoted to extern
pub extern fn warn(fmt: [*c]const u8, ...) void;
// src/submodules/beanstalkd/util.c:42:1: warning: TODO unable to translate variadic function, demoted to extern
pub extern fn warnx(fmt: [*c]const u8, ...) void;
// src/submodules/beanstalkd/util.c:52:1: warning: TODO unable to translate variadic function, demoted to extern
pub extern fn fmtalloc(fmt: [*c]u8, ...) [*c]u8;
pub export fn zalloc(arg_n: c_int) ?*anyopaque {
    var n = arg_n;
    _ = &n;
    var p: ?*anyopaque = undefined;
    _ = &p;
    p = malloc(@as(c_ulong, @bitCast(@as(c_long, n))));
    if (p != null) {
        _ = memset(p, @as(c_int, 0), @as(c_ulong, @bitCast(@as(c_long, n))));
    }
    return p;
}
pub export fn optparse(arg_s: [*c]Server, arg_argv: [*c][*c]u8) void {
    var s = arg_s;
    _ = &s;
    var argv = arg_argv;
    _ = &argv;
    var ms: int64 = undefined;
    _ = &ms;
    ...
    while ((((blk: {
        ...
        arg = tmp_1;
        break :blk tmp_1;
    }) != null) and (@as(c_int, @bitCast(@as(c_uint, (blk: {
        const ref = &arg;
        const tmp_1 = ref.*;
        ref.* += 1;
        break :blk tmp_1;
    }).*))) == @as(c_int, '-'))) and (@as(c_int, @bitCast(@as(c_uint, arg.*))) != 0)) {
        var c: u8 = undefined;
        _ = &c;
        while ((blk: {
            const tmp_1 = (blk_1: {
            ...
            while (true) {
                switch (@as(c_int, @bitCast(@as(c_uint, c)))) {
                    @as(c_int, 112) => {
                        s.*.port = if (@as(c_int, @bitCast(@as(c_uint, arg.*))) != 0) blk: {
                            _ = blk_1: {
                                tmp = arg;
                                break :blk_1 blk_2: {
                                    const tmp_3 = "";
                            ...
                            break :blk tmp;
                        } else if (argv.* != null) (blk: {
                            const ref = &argv;
                            const tmp_1 = ref.*;
                            ref.* += 1;
                            break :blk tmp_1;
                        }).* else flagusage(@as([*c]u8, @ptrCast(@volatileCast(@constCast("-p")))));
                        warn_systemd_ignored_option(@as([*c]u8, @ptrCast(@volatileCast(@constCast("-p")))), s.*.port);
                        break;
                    },
                    @as(c_int, 108) => {
                        s.*.addr = if (@as(c_int, @bitCast(@as(c_uint, arg.*))) != 0) blk: {
                            _ = blk_1: {
                                tmp = arg;
                                break :blk_1 blk_2: {
                                    const tmp_3 = "";
                            ...
                            ref.* += 1;
                            break :blk tmp_1;
                        }).* else flagusage(@as([*c]u8, @ptrCast(@volatileCast(@constCast("-l")))));
                        warn_systemd_ignored_option(@as([*c]u8, @ptrCast(@volatileCast(@constCast("-l")))), s.*.addr);
                        break;
                    },
                    @as(c_int, 122) => {
                        job_data_size_limit = parse_size_t(if (@as(c_int, @bitCast(@as(c_uint, arg.*))) != 0) blk: {
                            _ = blk_1: {
                                tmp = arg;
                                break :blk_1 blk_2: {
                                    const tmp_3 = "";
                            ...
                            ref.* += 1;
                            break :blk tmp_1;
                        }).* else flagusage(@as([*c]u8, @ptrCast(@volatileCast(@constCast("-z"))))));
                        if (job_data_size_limit > @as(usize, @bitCast(@as(c_long, @as(c_int, 1073741824))))) {
                            warnx("maximum job size was set to %d", @as(c_int, 1073741824));
                            job_data_size_limit = @as(usize, @bitCast(@as(c_long, @as(c_int, 1073741824))));
                        }
                        break;
                    },
                    @as(c_int, 115) => {
                        s.*.wal.filesize = @as(c_int, @bitCast(@as(c_uint, @truncate(parse_size_t(if (@as(c_int, @bitCast(@as(c_uint, arg.*))) != 0) blk: {
                            _ = blk_1: {
                                tmp = arg;
                                break :blk_1 blk_2: {
                                    const tmp_3 = "";
                            ...
                            ref.* += 1;
                            break :blk tmp_1;
                        }).* else flagusage(@as([*c]u8, @ptrCast(@volatileCast(@constCast("-s"))))))))));
                        break;
                    },
                    @as(c_int, 99) => {
                    ...
                    @as(c_int, 102) => {
                        ms = @as(int64, @bitCast(parse_size_t(if (@as(c_int, @bitCast(@as(c_uint, arg.*))) != 0) blk: {
                            _ = blk_1: {
                                tmp = arg;
                                break :blk_1 blk_2: {
                                    const tmp_3 = "";
                            ...
                            ref.* += 1;
                            break :blk tmp_1;
                        }).* else flagusage(@as([*c]u8, @ptrCast(@volatileCast(@constCast("-f"))))))));
                        s.*.wal.syncrate = ms * @as(int64, @bitCast(@as(c_long, @as(c_int, 1000000))));
                        s.*.wal.wantsync = 1;
                        break;
                    },
                    @as(c_int, 70) => {
                    ...
                    @as(c_int, 117) => {
                        s.*.user = if (@as(c_int, @bitCast(@as(c_uint, arg.*))) != 0) blk: {
                            _ = blk_1: {
                                tmp = arg;
                                break :blk_1 blk_2: {
                                    const tmp_3 = "";
                            ...
                            ref.* += 1;
                            break :blk tmp_1;
                        }).* else flagusage(@as([*c]u8, @ptrCast(@volatileCast(@constCast("-u")))));
                        break;
                    },
                    @as(c_int, 98) => {
                        s.*.wal.dir = if (@as(c_int, @bitCast(@as(c_uint, arg.*))) != 0) blk: {
                            _ = blk_1: {
                                tmp = arg;
                                break :blk_1 blk_2: {
                                    const tmp_3 = "";
                            ...
                            ref.* += 1;
                            break :blk tmp_1;
                        }).* else flagusage(@as([*c]u8, @ptrCast(@volatileCast(@constCast("-b")))));
                        s.*.wal.use = 1;
                        break;
                    },
                    @as(c_int, 104) => {
                        usage(@as(c_int, 0));
                        _ = printf("beanstalkd %s\n", @as([*c]const u8, @ptrCast(@alignCast(&version))));
                        exit(@as(c_int, 0));
                        verbose += 1;
                        break;
                    },
                    ...
                    @as(c_int, 86) => {
                        ...
                        warnx("unknown flag: %s", arg - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 2))))));
                        usage(@as(c_int, 5));
                    },
                }
                break;
    ...
    if (arg != null) {
        warnx("unknown argument: %s", arg - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1))))));
        usage(@as(c_int, 5));
    }
}
...
pub fn vwarnx(arg_err: [*c]const u8, arg_fmt: [*c]const u8, arg_args: [*c]struct___va_list_tag_5) callconv(.C) void {
    var err = arg_err;
    _ = &err;
    var fmt = arg_fmt;
    _ = &fmt;
...
pub fn parse_size_t(arg_str: [*c]u8) callconv(.C) usize {
    ...
    _ = &size;
    r = @as(u8, @bitCast(@as(i8, @truncate(sscanf(str, "%zu%c", &size, &x)))));
    if (@as(c_int, 1) != @as(c_int, @bitCast(@as(c_uint, r)))) {
...
pub const EARGF = @compileError("unable to translate macro: undefined identifier `arg`");
// src/submodules/beanstalkd/util.c:159:12
