...
pub export fn cttest_job_creation() void {
    ...
    j = make_job_with_id(@as(uint, @bitCast(@as(c_int, 1))), @as(int64, @bitCast(@as(c_long, @as(c_int, 0)))), @as(int64, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_int, 0), default_tube, @as(uint64, @bitCast(@as(c_long, @as(c_int, 0)))));
    while (true) {
        if (!(j.*.r.pri == @as(uint32, @bitCast(@as(c_int, 1))))) {
            ctlogpn("src/submodules/beanstalkd/testjobs.c", @as(c_int, 18), "%s", "test: j->r.pri == 1");
            ctlogpn("src/submodules/beanstalkd/testjobs.c", @as(c_int, 18), "priority should match");
            ctfailnow();
        }
        if (!false) break;
    }
}
pub export fn cttest_job_cmp_pris() void {
    var a: [*c]Job = undefined;
    _ = &a;
    var b: [*c]Job = undefined;
    _ = &b;
    _ = blk: {
        _ = blk_1: {
            tube_dref(default_tube);
    ...
    a = make_job_with_id(@as(uint, @bitCast(@as(c_int, 1))), @as(int64, @bitCast(@as(c_long, @as(c_int, 0)))), @as(int64, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_int, 0), default_tube, @as(uint64, @bitCast(@as(c_long, @as(c_int, 0)))));
    b = make_job_with_id(@as(uint, @bitCast(@as(c_int, 1) << @intCast(27))), @as(int64, @bitCast(@as(c_long, @as(c_int, 0)))), @as(int64, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_int, 0), default_tube, @as(uint64, @bitCast(@as(c_long, @as(c_int, 0)))));
    while (true) {
        if (!(job_pri_less(@as(?*anyopaque, @ptrCast(a)), @as(?*anyopaque, @ptrCast(b))) != 0)) {
            ctlogpn("src/submodules/beanstalkd/testjobs.c", @as(c_int, 30), "%s", "test: job_pri_less(a, b)");
            ctlogpn("src/submodules/beanstalkd/testjobs.c", @as(c_int, 30), "should be less");
            ctfailnow();
        }
        if (!false) break;
    }
}
pub export fn cttest_job_cmp_ids() void {
    var a: [*c]Job = undefined;
    _ = &a;
    var b: [*c]Job = undefined;
    _ = &b;
    ...
    a = make_job_with_id(@as(uint, @bitCast(@as(c_int, 1))), @as(int64, @bitCast(@as(c_long, @as(c_int, 0)))), @as(int64, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_int, 0), default_tube, @as(uint64, @bitCast(@as(c_long, @as(c_int, 0)))));
    b = make_job_with_id(@as(uint, @bitCast(@as(c_int, 1))), @as(int64, @bitCast(@as(c_long, @as(c_int, 0)))), @as(int64, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_int, 0), default_tube, @as(uint64, @bitCast(@as(c_long, @as(c_int, 0)))));
    b.*.r.id <<= @intCast(@as(c_int, 49));
    while (true) {
        if (!(job_pri_less(@as(?*anyopaque, @ptrCast(a)), @as(?*anyopaque, @ptrCast(b))) != 0)) {
            ctlogpn("src/submodules/beanstalkd/testjobs.c", @as(c_int, 43), "%s", "test: job_pri_less(a, b)");
            ctlogpn("src/submodules/beanstalkd/testjobs.c", @as(c_int, 43), "should be less");
            ctfailnow();
        }
        if (!false) break;
    }
}
pub export fn cttest_job_large_pris() void {
    var a: [*c]Job = undefined;
    _ = &a;
    var b: [*c]Job = undefined;
    _ = &b;
    ...
    a = make_job_with_id(@as(uint, @bitCast(@as(c_int, 1))), @as(int64, @bitCast(@as(c_long, @as(c_int, 0)))), @as(int64, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_int, 0), default_tube, @as(uint64, @bitCast(@as(c_long, @as(c_int, 0)))));
    b = make_job_with_id(@as(uint, @bitCast(-@as(c_int, 5))), @as(int64, @bitCast(@as(c_long, @as(c_int, 0)))), @as(int64, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_int, 0), default_tube, @as(uint64, @bitCast(@as(c_long, @as(c_int, 0)))));
    while (true) {
        if (!(job_pri_less(@as(?*anyopaque, @ptrCast(a)), @as(?*anyopaque, @ptrCast(b))) != 0)) {
            ctlogpn("src/submodules/beanstalkd/testjobs.c", @as(c_int, 55), "%s", "test: job_pri_less(a, b)");
            ctlogpn("src/submodules/beanstalkd/testjobs.c", @as(c_int, 55), "should be less");
            ctfailnow();
        }
        if (!false) break;
    }
    a = make_job_with_id(@as(uint, @bitCast(-@as(c_int, 5))), @as(int64, @bitCast(@as(c_long, @as(c_int, 0)))), @as(int64, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_int, 0), default_tube, @as(uint64, @bitCast(@as(c_long, @as(c_int, 0)))));
    b = make_job_with_id(@as(uint, @bitCast(@as(c_int, 1))), @as(int64, @bitCast(@as(c_long, @as(c_int, 0)))), @as(int64, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_int, 0), default_tube, @as(uint64, @bitCast(@as(c_long, @as(c_int, 0)))));
    while (true) {
        if (!!(job_pri_less(@as(?*anyopaque, @ptrCast(a)), @as(?*anyopaque, @ptrCast(b))) != 0)) {
            ctlogpn("src/submodules/beanstalkd/testjobs.c", @as(c_int, 60), "%s", "test: !job_pri_less(a, b)");
            ctlogpn("src/submodules/beanstalkd/testjobs.c", @as(c_int, 60), "should not be less");
            ctfailnow();
        }
        if (!false) break;
    }
}
pub export fn cttest_job_hash_free() void {
    var j: [*c]Job = undefined;
    _ = &j;
    var jid: uint64 = 83;
    _ = &jid;
    ...
    j = make_job_with_id(@as(uint, @bitCast(@as(c_int, 0))), @as(int64, @bitCast(@as(c_long, @as(c_int, 0)))), @as(int64, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_int, 0), default_tube, jid);
    job_free(j);
    while (true) {
        if (!!(job_find(jid) != null)) {
            ctlogpn("src/submodules/beanstalkd/testjobs.c", @as(c_int, 73), "%s", "test: !job_find(jid)");
            ctlogpn("src/submodules/beanstalkd/testjobs.c", @as(c_int, 73), "job should be missing");
            ctfailnow();
        }
        if (!false) break;
    }
}
pub export fn cttest_job_hash_free_next() void {
    var a: [*c]Job = undefined;
    _ = &a;
    var b: [*c]Job = undefined;
    _ = &b;
    var aid: uint64 = 97;
    _ = &aid;
    var bid: uint64 = @as(uint64, @bitCast(@as(c_long, @as(c_int, 12386))));
    _ = &bid;
    _ = blk: {
        _ = blk_1: {
            tube_dref(default_tube);
    ...
    b = make_job_with_id(@as(uint, @bitCast(@as(c_int, 0))), @as(int64, @bitCast(@as(c_long, @as(c_int, 0)))), @as(int64, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_int, 0), default_tube, bid);
    a = make_job_with_id(@as(uint, @bitCast(@as(c_int, 0))), @as(int64, @bitCast(@as(c_long, @as(c_int, 0)))), @as(int64, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_int, 0), default_tube, aid);
    while (true) {
        if (!(a.*.ht_next == b)) {
            ctlogpn("src/submodules/beanstalkd/testjobs.c", @as(c_int, 86), "%s", "test: a->ht_next == b");
            ctlogpn("src/submodules/beanstalkd/testjobs.c", @as(c_int, 86), "b should be chained to a");
            ctfailnow();
        }
        if (!false) break;
    }
    job_free(b);
    while (true) {
        if (!(a.*.ht_next == @as([*c]Job, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
            ctlogpn("src/submodules/beanstalkd/testjobs.c", @as(c_int, 90), "%s", "test: a->ht_next == NULL");
            ctlogpn("src/submodules/beanstalkd/testjobs.c", @as(c_int, 90), "job should be missing");
            ctfailnow();
        }
        if (!false) break;
    }
}
pub export fn cttest_job_all_jobs_used() void {
    var j: [*c]Job = undefined;
    _ = &j;
    var x: [*c]Job = undefined;
    _ = &x;
    _ = blk: {
        _ = blk_1: {
            tube_dref(default_tube);
    ...
    j = make_job_with_id(@as(uint, @bitCast(@as(c_int, 0))), @as(int64, @bitCast(@as(c_long, @as(c_int, 0)))), @as(int64, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_int, 0), default_tube, @as(uint64, @bitCast(@as(c_long, @as(c_int, 0)))));
    while (true) {
        if (!(get_all_jobs_used() == @as(usize, @bitCast(@as(c_long, @as(c_int, 1)))))) {
            ctlogpn("src/submodules/beanstalkd/testjobs.c", @as(c_int, 100), "%s", "test: get_all_jobs_used() == 1");
            ctlogpn("src/submodules/beanstalkd/testjobs.c", @as(c_int, 100), "should match");
            ctfailnow();
        }
        if (!false) break;
    }
    x = allocate_job(@as(c_int, 10));
    while (true) {
        if (!(get_all_jobs_used() == @as(usize, @bitCast(@as(c_long, @as(c_int, 1)))))) {
            ctlogpn("src/submodules/beanstalkd/testjobs.c", @as(c_int, 103), "%s", "test: get_all_jobs_used() == 1");
            ctlogpn("src/submodules/beanstalkd/testjobs.c", @as(c_int, 103), "should match");
            ctfailnow();
        }
        if (!false) break;
    }
    ...
    while (true) {
        if (!(get_all_jobs_used() == @as(usize, @bitCast(@as(c_long, @as(c_int, 1)))))) {
            ctlogpn("src/submodules/beanstalkd/testjobs.c", @as(c_int, 106), "%s", "test: get_all_jobs_used() == 1");
            ctlogpn("src/submodules/beanstalkd/testjobs.c", @as(c_int, 106), "should match");
            ctfailnow();
        }
        if (!false) break;
    }
    job_free(j);
    while (true) {
        if (!(get_all_jobs_used() == @as(usize, @bitCast(@as(c_long, @as(c_int, 0)))))) {
            ctlogpn("src/submodules/beanstalkd/testjobs.c", @as(c_int, 109), "%s", "test: get_all_jobs_used() == 0");
            ctlogpn("src/submodules/beanstalkd/testjobs.c", @as(c_int, 109), "should match");
            ctfailnow();
        }
        if (!false) break;
    }
}
pub export fn cttest_job_100_000_jobs() void {
    ...
    {
        i = 0;
        while (i < @as(c_int, 100000)) : (i += 1) {
            _ = make_job_with_id(@as(uint, @bitCast(@as(c_int, 0))), @as(int64, @bitCast(@as(c_long, @as(c_int, 0)))), @as(int64, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_int, 0), default_tube, @as(uint64, @bitCast(@as(c_long, @as(c_int, 0)))));
        }
    }
    while (true) {
        if (!(get_all_jobs_used() == @as(usize, @bitCast(@as(c_long, @as(c_int, 100000)))))) {
            ctlogpn("src/submodules/beanstalkd/testjobs.c", @as(c_int, 121), "%s", "test: get_all_jobs_used() == 100000");
            ctlogpn("src/submodules/beanstalkd/testjobs.c", @as(c_int, 121), "should match");
            ctfailnow();
        }
        if (!false) break;
    }
    {
        i = 1;
        while (i <= @as(c_int, 100000)) : (i += 1) {
            job_free(job_find(@as(uint64, @bitCast(@as(c_long, i)))));
        }
    }
    _ = fprintf(stderr, "get_all_jobs_used() => %zu\n", get_all_jobs_used());
    while (true) {
        if (!(get_all_jobs_used() == @as(usize, @bitCast(@as(c_long, @as(c_int, 0)))))) {
            ctlogpn("src/submodules/beanstalkd/testjobs.c", @as(c_int, 127), "%s", "test: get_all_jobs_used() == 0");
            ctlogpn("src/submodules/beanstalkd/testjobs.c", @as(c_int, 127), "should match");
            ctfailnow();
        }
        if (!false) break;
    }
}
pub export fn ctbench_job_make(arg_n: c_int) void {
    var n = arg_n;
    _ = &n;
    var i: c_int = undefined;
    _ = &i;
    ...
    ctresettimer();
    {
        ...
        while (i < n) : (i += 1) {
            ...
            }).* = make_job_with_id(@as(uint, @bitCast(@as(c_int, 0))), @as(int64, @bitCast(@as(c_long, @as(c_int, 0)))), @as(int64, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_int, 0), default_tube, @as(uint64, @bitCast(@as(c_long, @as(c_int, 0)))));
        }
    }
    ctstoptimer();
    {
...
pub export fn ctbench_job_free(arg_n: c_int) void {
    var n = arg_n;
    _ = &n;
    var i: c_int = undefined;
    _ = &i;
