...
pub const struct___va_list_tag_28 = extern struct {
    gp_offset: c_uint = @import("std").mem.zeroes(c_uint),
    fp_offset: c_uint = @import("std").mem.zeroes(c_uint),
    overflow_arg_area: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    reg_save_area: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
};
pub const __builtin_va_list = [1]struct___va_list_tag_28;
...
pub extern fn vfprintf(noalias __s: [*c]FILE, noalias __format: [*c]const u8, __arg: [*c]struct___va_list_tag_28) c_int;
pub extern fn vprintf(noalias __format: [*c]const u8, __arg: [*c]struct___va_list_tag_28) c_int;
pub extern fn vsprintf(noalias __s: [*c]u8, noalias __format: [*c]const u8, __arg: [*c]struct___va_list_tag_28) c_int;
pub extern fn snprintf(noalias __s: [*c]u8, __maxlen: c_ulong, noalias __format: [*c]const u8, ...) c_int;
pub extern fn vsnprintf(noalias __s: [*c]u8, __maxlen: c_ulong, noalias __format: [*c]const u8, __arg: [*c]struct___va_list_tag_28) c_int;
pub extern fn vasprintf(noalias __ptr: [*c][*c]u8, noalias __f: [*c]const u8, __arg: [*c]struct___va_list_tag_28) c_int;
pub extern fn __asprintf(noalias __ptr: [*c][*c]u8, noalias __fmt: [*c]const u8, ...) c_int;
pub extern fn asprintf(noalias __ptr: [*c][*c]u8, noalias __fmt: [*c]const u8, ...) c_int;
pub extern fn vdprintf(__fd: c_int, noalias __fmt: [*c]const u8, __arg: [*c]struct___va_list_tag_28) c_int;
pub extern fn dprintf(__fd: c_int, noalias __fmt: [*c]const u8, ...) c_int;
pub extern fn fscanf(noalias __stream: [*c]FILE, noalias __format: [*c]const u8, ...) c_int;
pub extern fn scanf(noalias __format: [*c]const u8, ...) c_int;
pub extern fn sscanf(noalias __s: [*c]const u8, noalias __format: [*c]const u8, ...) c_int;
pub extern fn vfscanf(noalias __s: [*c]FILE, noalias __format: [*c]const u8, __arg: [*c]struct___va_list_tag_28) c_int;
pub extern fn vscanf(noalias __format: [*c]const u8, __arg: [*c]struct___va_list_tag_28) c_int;
pub extern fn vsscanf(noalias __s: [*c]const u8, noalias __format: [*c]const u8, __arg: [*c]struct___va_list_tag_28) c_int;
...
pub fn su(arg_user: [*c]const u8) callconv(.C) void {
    var user = arg_user;
    _ = &user;
    __errno_location().* = 0;
    var pwent: [*c]struct_passwd = getpwnam(user);
    _ = &pwent;
    if (__errno_location().* != 0) {
        warn("%s:%d in %s: getpwnam(\"%s\")%s", "src/submodules/beanstalkd/main.c", @as(c_int, 18), "su", user, "");
        exit(@as(c_int, 32));
    }
    if (!(pwent != null)) {
        warnx("%s:%d in %s: getpwnam(\"%s\"): no such user%s", "src/submodules/beanstalkd/main.c", @as(c_int, 22), "su", user, "");
        exit(@as(c_int, 33));
    }
    var r: c_int = setgid(pwent.*.pw_gid);
    _ = &r;
    if (r == -@as(c_int, 1)) {
        warn("%s:%d in %s: setgid(%d \"%s\")%s", "src/submodules/beanstalkd/main.c", @as(c_int, 28), "su", pwent.*.pw_gid, user, "");
        exit(@as(c_int, 34));
    }
    r = setuid(pwent.*.pw_uid);
    if (r == -@as(c_int, 1)) {
        warn("%s:%d in %s: setuid(%d \"%s\")%s", "src/submodules/beanstalkd/main.c", @as(c_int, 34), "su", pwent.*.pw_uid, user, "");
        exit(@as(c_int, 34));
    }
}
pub fn handle_sigterm_pid1() callconv(.C) void {
    exit(@as(c_int, 143));
}
pub fn set_sig_handlers() callconv(.C) void {
    var sa: struct_sigaction = undefined;
    _ = &sa;
    sa.__sigaction_handler.sa_handler = @as(__sighandler_t, @ptrFromInt(@as(c_int, 1)));
    sa.sa_flags = 0;
    var r: c_int = sigemptyset(&sa.sa_mask);
    _ = &r;
    if (r == -@as(c_int, 1)) {
        warn("%s:%d in %s: sigemptyset()%s", "src/submodules/beanstalkd/main.c", @as(c_int, 54), "set_sig_handlers", "");
        exit(@as(c_int, 111));
    }
    r = sigaction(@as(c_int, 13), &sa, null);
    if (r == -@as(c_int, 1)) {
        warn("%s:%d in %s: sigaction(SIGPIPE)%s", "src/submodules/beanstalkd/main.c", @as(c_int, 60), "set_sig_handlers", "");
        exit(@as(c_int, 111));
    }
    sa.__sigaction_handler.sa_handler = &enter_drain_mode;
    r = sigaction(@as(c_int, 10), &sa, null);
    if (r == -@as(c_int, 1)) {
        warn("%s:%d in %s: sigaction(SIGUSR1)%s", "src/submodules/beanstalkd/main.c", @as(c_int, 67), "set_sig_handlers", "");
        exit(@as(c_int, 111));
    }
    if (getpid() == @as(c_int, 1)) {
        sa.__sigaction_handler.sa_handler = @as(__sighandler_t, @ptrCast(@alignCast(&handle_sigterm_pid1)));
        r = sigaction(@as(c_int, 15), &sa, null);
        if (r == -@as(c_int, 1)) {
            warn("%s:%d in %s: sigaction(SIGTERM)%s", "src/submodules/beanstalkd/main.c", @as(c_int, 78), "set_sig_handlers", "");
            exit(@as(c_int, 111));
        }
    }
}
pub export fn main(arg_argc: c_int, arg_argv: [*c][*c]u8) c_int {
    ...
    setlinebuf(stdout);
    optparse(&srv, argv + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1))))));
    if (verbose != 0) {
        _ = printf("pid %d\n", getpid());
    }
    var r: c_int = make_server_socket(srv.addr, srv.port);
    _ = &r;
    if (r == -@as(c_int, 1)) {
        warnx("%s:%d in %s: make_server_socket()%s", "src/submodules/beanstalkd/main.c", @as(c_int, 99), "main", "");
        exit(@as(c_int, 111));
    }
    srv.sock.fd = r;
    prot_init();
