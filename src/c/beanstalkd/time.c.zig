...
pub export fn nanoseconds() int64 {
    var r: c_int = undefined;
    _ = &r;
    var tv: struct_timeval = undefined;
    _ = &tv;
    r = gettimeofday(&tv, null);
    if (r != @as(c_int, 0)) return @as(int64, @bitCast(@as(c_long, blk: {
        warnx("gettimeofday");
        break :blk -@as(c_int, 1);
    })));
    return (@as(int64, @bitCast(tv.tv_sec)) * @as(int64, @bitCast(@as(c_long, @as(c_int, 1000000000))))) + (@as(int64, @bitCast(tv.tv_usec)) * @as(int64, @bitCast(@as(c_long, @as(c_int, 1000)))));
}
