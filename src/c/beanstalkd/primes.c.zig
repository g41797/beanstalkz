...
pub export var primes: [48]usize = [48]usize{
    @as(usize, @bitCast(@as(c_long, @as(c_int, 12289)))),
    @as(usize, @bitCast(@as(c_long, @as(c_int, 24593)))),
    @as(usize, @bitCast(@as(c_long, @as(c_int, 49193)))),
    @as(usize, @bitCast(@as(c_long, @as(c_int, 98387)))),
    @as(usize, @bitCast(@as(c_long, @as(c_int, 196799)))),
    @as(usize, @bitCast(@as(c_long, @as(c_int, 393611)))),
    @as(usize, @bitCast(@as(c_long, @as(c_int, 787243)))),
    @as(usize, @bitCast(@as(c_long, @as(c_int, 1574491)))),
    @as(usize, @bitCast(@as(c_long, @as(c_int, 3148987)))),
    @as(usize, @bitCast(@as(c_long, @as(c_int, 6297979)))),
    @as(usize, @bitCast(@as(c_long, @as(c_int, 12595991)))),
    @as(usize, @bitCast(@as(c_long, @as(c_int, 25191989)))),
    @as(usize, @bitCast(@as(c_long, @as(c_int, 50383981)))),
    @as(usize, @bitCast(@as(c_long, @as(c_int, 100767977)))),
    @as(usize, @bitCast(@as(c_long, @as(c_int, 201535967)))),
    @as(usize, @bitCast(@as(c_long, @as(c_int, 403071937)))),
    @as(usize, @bitCast(@as(c_long, @as(c_int, 806143879)))),
    @as(usize, @bitCast(@as(c_long, @as(c_int, 1612287763)))),
    3224575537,
    @as(usize, @bitCast(@as(c_long, 6449151103))),
    @as(usize, @bitCast(@as(c_long, 12898302233))),
    @as(usize, @bitCast(@as(c_long, 25796604473))),
    @as(usize, @bitCast(@as(c_long, 51593208973))),
    @as(usize, @bitCast(@as(c_long, 103186417951))),
    @as(usize, @bitCast(@as(c_long, 206372835917))),
    @as(usize, @bitCast(@as(c_long, 412745671837))),
    @as(usize, @bitCast(@as(c_long, 825491343683))),
    @as(usize, @bitCast(@as(c_long, 1650982687391))),
    @as(usize, @bitCast(@as(c_long, 3301965374803))),
    @as(usize, @bitCast(@as(c_long, 6603930749621))),
    @as(usize, @bitCast(@as(c_long, 13207861499251))),
    @as(usize, @bitCast(@as(c_long, 26415722998507))),
    @as(usize, @bitCast(@as(c_long, 52831445997037))),
    @as(usize, @bitCast(@as(c_long, 105662891994103))),
    @as(usize, @bitCast(@as(c_long, 211325783988211))),
    @as(usize, @bitCast(@as(c_long, 422651567976461))),
    @as(usize, @bitCast(@as(c_long, 845303135952931))),
    @as(usize, @bitCast(@as(c_long, 1690606271905871))),
    @as(usize, @bitCast(@as(c_long, 3381212543811743))),
    @as(usize, @bitCast(@as(c_long, 6762425087623523))),
    @as(usize, @bitCast(@as(c_long, 13524850175247127))),
    @as(usize, @bitCast(@as(c_long, 27049700350494287))),
    @as(usize, @bitCast(@as(c_long, 54099400700988593))),
    @as(usize, @bitCast(@as(c_long, 108198801401977301))),
    @as(usize, @bitCast(@as(c_long, 216397602803954641))),
    @as(usize, @bitCast(@as(c_long, 432795205607909293))),
    @as(usize, @bitCast(@as(c_long, 865590411215818597))),
    @as(usize, @bitCast(@as(c_long, 1731180822431637217))),
};
