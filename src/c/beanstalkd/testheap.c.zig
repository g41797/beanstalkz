...
pub export fn cttest_heap_insert_one() void {
    var h: Heap = Heap{
        .cap = @import("std").mem.zeroes(usize),
    ...
    _ = &h;
    var j: [*c]Job = make_job_with_id(@as(uint, @bitCast(@as(c_int, 1))), @as(int64, @bitCast(@as(c_long, @as(c_int, 0)))), @as(int64, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_int, 0), null, @as(uint64, @bitCast(@as(c_long, @as(c_int, 0)))));
    _ = &j;
    while (true) {
        if (!(j != null)) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 19), "%s", "test: j");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 19), "allocate job");
            ctfailnow();
        }
        if (!false) break;
    }
    _ = heapinsert(&h, @as(?*anyopaque, @ptrCast(j)));
    while (true) {
        if (!(h.len == @as(usize, @bitCast(@as(c_long, @as(c_int, 1)))))) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 22), "%s", "test: h.len == 1");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 22), "h should contain one item.");
            ctfailnow();
        }
        if (!false) break;
    }
    while (true) {
        if (!(j.*.heap_index == @as(usize, @bitCast(@as(c_long, @as(c_int, 0)))))) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 23), "%s", "test: j->heap_index == 0");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 23), "should match");
            ctfailnow();
        }
        if (!false) break;
    }
    while (true) {
        if (!(heapremove(&h, @as(usize, @bitCast(@as(c_long, @as(c_int, 0))))) != null)) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 25), "%s", "test: heapremove(&h, 0)");
            ctfailnow();
        }
        if (!false) break;
    }
    job_free(j);
    free(@as(?*anyopaque, @ptrCast(h.data)));
}
pub export fn cttest_heap_insert_and_remove_one() void {
    var h: Heap = Heap{
        .cap = @import("std").mem.zeroes(usize),
        .len = @import("std").mem.zeroes(usize),
        .data = null,
    ...
    _ = &h;
    var j1: [*c]Job = make_job_with_id(@as(uint, @bitCast(@as(c_int, 1))), @as(int64, @bitCast(@as(c_long, @as(c_int, 0)))), @as(int64, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_int, 0), null, @as(uint64, @bitCast(@as(c_long, @as(c_int, 0)))));
    _ = &j1;
    while (true) {
        if (!(j1 != null)) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 39), "%s", "test: j1");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 39), "allocate job");
            ctfailnow();
        }
        if (!false) break;
    }
    var r: c_int = heapinsert(&h, @as(?*anyopaque, @ptrCast(j1)));
    _ = &r;
    while (true) {
        if (!(r != 0)) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 42), "%s", "test: r");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 42), "insert should succeed");
            ctfailnow();
        }
        if (!false) break;
    }
    var got: [*c]Job = @as([*c]Job, @ptrCast(@alignCast(heapremove(&h, @as(usize, @bitCast(@as(c_long, @as(c_int, 0))))))));
    _ = &got;
    while (true) {
        if (!(got == j1)) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 45), "%s", "test: got == j1");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 45), "j1 should come back out");
            ctfailnow();
        }
        if (!false) break;
    }
    while (true) {
        if (!(h.len == @as(usize, @bitCast(@as(c_long, @as(c_int, 0)))))) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 46), "%s", "test: h.len == 0");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 46), "h should be empty.");
            ctfailnow();
        }
        if (!false) break;
    }
...
pub export fn cttest_heap_priority() void {
    var h: Heap = Heap{
        .cap = @import("std").mem.zeroes(usize),
        .len = @import("std").mem.zeroes(usize),
        .data = null,
    ...
    _ = &j;
    var j1: [*c]Job = undefined;
    _ = &j1;
    var j2: [*c]Job = undefined;
    _ = &j2;
    var j3: [*c]Job = undefined;
    _ = &j3;
    j1 = make_job_with_id(@as(uint, @bitCast(@as(c_int, 1))), @as(int64, @bitCast(@as(c_long, @as(c_int, 0)))), @as(int64, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_int, 0), null, @as(uint64, @bitCast(@as(c_long, @as(c_int, 0)))));
    j2 = make_job_with_id(@as(uint, @bitCast(@as(c_int, 2))), @as(int64, @bitCast(@as(c_long, @as(c_int, 0)))), @as(int64, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_int, 0), null, @as(uint64, @bitCast(@as(c_long, @as(c_int, 0)))));
    j3 = make_job_with_id(@as(uint, @bitCast(@as(c_int, 3))), @as(int64, @bitCast(@as(c_long, @as(c_int, 0)))), @as(int64, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_int, 0), null, @as(uint64, @bitCast(@as(c_long, @as(c_int, 0)))));
    while (true) {
        if (!(j1 != null)) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 64), "%s", "test: j1");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 64), "allocate job");
            ctfailnow();
        }
        if (!false) break;
    }
    while (true) {
        if (!(j2 != null)) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 65), "%s", "test: j2");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 65), "allocate job");
            ctfailnow();
        }
        if (!false) break;
    }
    while (true) {
        if (!(j3 != null)) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 66), "%s", "test: j3");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 66), "allocate job");
            ctfailnow();
        }
        if (!false) break;
    }
    var r: c_int = heapinsert(&h, @as(?*anyopaque, @ptrCast(j2)));
    _ = &r;
    while (true) {
        if (!(r != 0)) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 69), "%s", "test: r");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 69), "insert should succeed");
            ctfailnow();
        }
        if (!false) break;
    }
    while (true) {
        if (!(j2.*.heap_index == @as(usize, @bitCast(@as(c_long, @as(c_int, 0)))))) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 70), "%s", "test: j2->heap_index == 0");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 70), "should match");
            ctfailnow();
        }
        if (!false) break;
    }
    r = heapinsert(&h, @as(?*anyopaque, @ptrCast(j3)));
    while (true) {
        if (!(r != 0)) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 73), "%s", "test: r");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 73), "insert should succeed");
            ctfailnow();
        }
        if (!false) break;
    }
    while (true) {
        if (!(j2.*.heap_index == @as(usize, @bitCast(@as(c_long, @as(c_int, 0)))))) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 74), "%s", "test: j2->heap_index == 0");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 74), "should match");
            ctfailnow();
        }
        if (!false) break;
    }
    while (true) {
        if (!(j3.*.heap_index == @as(usize, @bitCast(@as(c_long, @as(c_int, 1)))))) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 75), "%s", "test: j3->heap_index == 1");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 75), "should match");
            ctfailnow();
        }
        if (!false) break;
    }
    r = heapinsert(&h, @as(?*anyopaque, @ptrCast(j1)));
    while (true) {
        if (!(r != 0)) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 78), "%s", "test: r");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 78), "insert should succeed");
            ctfailnow();
        }
        if (!false) break;
    }
    while (true) {
        if (!(j1.*.heap_index == @as(usize, @bitCast(@as(c_long, @as(c_int, 0)))))) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 79), "%s", "test: j1->heap_index == 0");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 79), "should match");
            ctfailnow();
        }
        if (!false) break;
    }
    while (true) {
        if (!(j2.*.heap_index == @as(usize, @bitCast(@as(c_long, @as(c_int, 2)))))) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 80), "%s", "test: j2->heap_index == 2");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 80), "should match");
            ctfailnow();
        }
        if (!false) break;
    }
    while (true) {
        if (!(j3.*.heap_index == @as(usize, @bitCast(@as(c_long, @as(c_int, 1)))))) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 81), "%s", "test: j3->heap_index == 1");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 81), "should match");
            ctfailnow();
        }
        if (!false) break;
    }
    j = @as([*c]Job, @ptrCast(@alignCast(heapremove(&h, @as(usize, @bitCast(@as(c_long, @as(c_int, 0))))))));
    while (true) {
        if (!(j == j1)) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 84), "%s", "test: j == j1");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 84), "j1 should come out first.");
            ctfailnow();
        }
        if (!false) break;
    }
    while (true) {
        if (!(j2.*.heap_index == @as(usize, @bitCast(@as(c_long, @as(c_int, 0)))))) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 85), "%s", "test: j2->heap_index == 0");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 85), "should match");
            ctfailnow();
        }
        if (!false) break;
    }
    while (true) {
        if (!(j3.*.heap_index == @as(usize, @bitCast(@as(c_long, @as(c_int, 1)))))) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 86), "%s", "test: j3->heap_index == 1");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 86), "should match");
            ctfailnow();
        }
        if (!false) break;
    }
    ...
    while (true) {
        if (!(j == j2)) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 89), "%s", "test: j == j2");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 89), "j2 should come out second.");
            ctfailnow();
        }
        if (!false) break;
    }
    while (true) {
        if (!(j3.*.heap_index == @as(usize, @bitCast(@as(c_long, @as(c_int, 0)))))) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 90), "%s", "test: j3->heap_index == 0");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 90), "should match");
            ctfailnow();
        }
        if (!false) break;
    }
    ...
    while (true) {
        if (!(j == j3)) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 93), "%s", "test: j == j3");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 93), "j3 should come out third.");
            ctfailnow();
        }
        if (!false) break;
    }
...
pub export fn cttest_heap_fifo_property() void {
    var h: Heap = Heap{
        .cap = @import("std").mem.zeroes(usize),
        .len = @import("std").mem.zeroes(usize),
        .data = null,
    ...
    var j: [*c]Job = undefined;
    _ = &j;
    var j3a: [*c]Job = undefined;
    _ = &j3a;
    var j3b: [*c]Job = undefined;
    _ = &j3b;
    var j3c: [*c]Job = undefined;
    _ = &j3c;
    j3a = make_job_with_id(@as(uint, @bitCast(@as(c_int, 3))), @as(int64, @bitCast(@as(c_long, @as(c_int, 0)))), @as(int64, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_int, 0), null, @as(uint64, @bitCast(@as(c_long, @as(c_int, 0)))));
    j3b = make_job_with_id(@as(uint, @bitCast(@as(c_int, 3))), @as(int64, @bitCast(@as(c_long, @as(c_int, 0)))), @as(int64, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_int, 0), null, @as(uint64, @bitCast(@as(c_long, @as(c_int, 0)))));
    j3c = make_job_with_id(@as(uint, @bitCast(@as(c_int, 3))), @as(int64, @bitCast(@as(c_long, @as(c_int, 0)))), @as(int64, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_int, 0), null, @as(uint64, @bitCast(@as(c_long, @as(c_int, 0)))));
    while (true) {
        if (!(j3a != null)) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 113), "%s", "test: j3a");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 113), "allocate job");
            ctfailnow();
        }
        if (!false) break;
    }
    while (true) {
        if (!(j3b != null)) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 114), "%s", "test: j3b");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 114), "allocate job");
            ctfailnow();
        }
        if (!false) break;
    }
    while (true) {
        if (!(j3c != null)) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 115), "%s", "test: j3c");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 115), "allocate job");
            ctfailnow();
        }
        if (!false) break;
    }
    var r: c_int = heapinsert(&h, @as(?*anyopaque, @ptrCast(j3a)));
    _ = &r;
    while (true) {
        if (!(r != 0)) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 118), "%s", "test: r");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 118), "insert should succeed");
            ctfailnow();
        }
        if (!false) break;
    }
    while (true) {
        if (!(h.data[@as(c_uint, @intCast(@as(c_int, 0)))] == @as(?*anyopaque, @ptrCast(j3a)))) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 119), "%s", "test: h.data[0] == j3a");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 119), "j3a should be in pos 0");
            ctfailnow();
        }
        if (!false) break;
    }
    while (true) {
        if (!(j3a.*.heap_index == @as(usize, @bitCast(@as(c_long, @as(c_int, 0)))))) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 120), "%s", "test: j3a->heap_index == 0");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 120), "should match");
            ctfailnow();
        }
        if (!false) break;
    }
    r = heapinsert(&h, @as(?*anyopaque, @ptrCast(j3b)));
    while (true) {
        if (!(r != 0)) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 123), "%s", "test: r");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 123), "insert should succeed");
            ctfailnow();
        }
        if (!false) break;
    }
    while (true) {
        if (!(h.data[@as(c_uint, @intCast(@as(c_int, 1)))] == @as(?*anyopaque, @ptrCast(j3b)))) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 124), "%s", "test: h.data[1] == j3b");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 124), "j3b should be in pos 1");
            ctfailnow();
        }
        if (!false) break;
    }
    while (true) {
        if (!(j3a.*.heap_index == @as(usize, @bitCast(@as(c_long, @as(c_int, 0)))))) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 125), "%s", "test: j3a->heap_index == 0");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 125), "should match");
            ctfailnow();
        }
        if (!false) break;
    }
    while (true) {
        if (!(j3b.*.heap_index == @as(usize, @bitCast(@as(c_long, @as(c_int, 1)))))) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 126), "%s", "test: j3b->heap_index == 1");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 126), "should match");
            ctfailnow();
        }
        if (!false) break;
    }
    r = heapinsert(&h, @as(?*anyopaque, @ptrCast(j3c)));
    while (true) {
        if (!(r != 0)) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 129), "%s", "test: r");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 129), "insert should succeed");
            ctfailnow();
        }
        if (!false) break;
    }
    while (true) {
        if (!(h.data[@as(c_uint, @intCast(@as(c_int, 2)))] == @as(?*anyopaque, @ptrCast(j3c)))) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 130), "%s", "test: h.data[2] == j3c");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 130), "j3c should be in pos 2");
            ctfailnow();
        }
        if (!false) break;
    }
    while (true) {
        if (!(j3a.*.heap_index == @as(usize, @bitCast(@as(c_long, @as(c_int, 0)))))) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 131), "%s", "test: j3a->heap_index == 0");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 131), "should match");
            ctfailnow();
        }
        if (!false) break;
    }
    while (true) {
        if (!(j3b.*.heap_index == @as(usize, @bitCast(@as(c_long, @as(c_int, 1)))))) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 132), "%s", "test: j3b->heap_index == 1");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 132), "should match");
            ctfailnow();
        }
        if (!false) break;
    }
    while (true) {
        if (!(j3c.*.heap_index == @as(usize, @bitCast(@as(c_long, @as(c_int, 2)))))) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 133), "%s", "test: j3c->heap_index == 2");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 133), "should match");
            ctfailnow();
        }
        if (!false) break;
    }
    ...
    while (true) {
        if (!(j == j3a)) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 136), "%s", "test: j == j3a");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 136), "j3a should come out first.");
            ctfailnow();
        }
        if (!false) break;
    }
    while (true) {
        if (!(j3b.*.heap_index == @as(usize, @bitCast(@as(c_long, @as(c_int, 0)))))) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 137), "%s", "test: j3b->heap_index == 0");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 137), "should match");
            ctfailnow();
        }
        if (!false) break;
    }
    while (true) {
        if (!(j3c.*.heap_index == @as(usize, @bitCast(@as(c_long, @as(c_int, 1)))))) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 138), "%s", "test: j3c->heap_index == 1");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 138), "should match");
            ctfailnow();
        }
        if (!false) break;
    }
    ...
    while (true) {
        if (!(j == j3b)) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 141), "%s", "test: j == j3b");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 141), "j3b should come out second.");
            ctfailnow();
        }
        if (!false) break;
    }
    while (true) {
        if (!(j3c.*.heap_index == @as(usize, @bitCast(@as(c_long, @as(c_int, 0)))))) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 142), "%s", "test: j3c->heap_index == 0");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 142), "should match");
            ctfailnow();
        }
        if (!false) break;
    }
    ...
    while (true) {
        if (!(j == j3c)) {
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 145), "%s", "test: j == j3c");
            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 145), "j3c should come out third.");
            ctfailnow();
        }
        if (!false) break;
    }
...
pub export fn cttest_heap_many_jobs() void {
    var h: Heap = Heap{
        .cap = @import("std").mem.zeroes(usize),
        .len = @import("std").mem.zeroes(usize),
        .data = null,
    ...
    _ = &i;
    {
        i = 0;
        while (i < n) : (i += 1) {
            j = make_job_with_id(@as(uint, @bitCast(@as(c_int, 1) + @import("std").zig.c_translation.signedRemainder(rand(), @as(c_int, 8192)))), @as(int64, @bitCast(@as(c_long, @as(c_int, 0)))), @as(int64, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_int, 0), null, @as(uint64, @bitCast(@as(c_long, @as(c_int, 0)))));
            while (true) {
                if (!(j != null)) {
                    ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 166), "%s", "test: j");
                    ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 166), "allocation");
                    ctfailnow();
                }
                if (!false) break;
            }
            var r: c_int = heapinsert(&h, @as(?*anyopaque, @ptrCast(j)));
            _ = &r;
            while (true) {
                if (!(r != 0)) {
                    ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 168), "%s", "test: r");
                    ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 168), "heapinsert");
                    ctfailnow();
                }
                if (!false) break;
            }
    ...
    _ = &last_pri;
    {
        ...
        while (i < n) : (i += 1) {
            ...
            while (true) {
                if (!(j.*.r.pri >= last_pri)) {
                    ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 174), "%s", "test: j->r.pri >= last_pri");
                    ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 174), "should come out in order");
                    ctfailnow();
                }
                if (!false) break;
            }
            ...
            while (true) {
                if (!(j != null)) {
                    ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 176), "%s", "test: j");
                    ctfailnow();
                }
                if (!false) break;
            }
...
pub export fn cttest_heap_remove_k() void {
    var h: Heap = Heap{
        .cap = @import("std").mem.zeroes(usize),
        .len = @import("std").mem.zeroes(usize),
        .data = null,
    ...
    {
        c = 0;
        while (c < @as(c_int, 50)) : (c += 1) {
            {
                i = 0;
                while (i < n) : (i += 1) {
                    var j: [*c]Job = make_job_with_id(@as(uint, @bitCast(@as(c_int, 1) + @import("std").zig.c_translation.signedRemainder(rand(), @as(c_int, 8192)))), @as(int64, @bitCast(@as(c_long, @as(c_int, 0)))), @as(int64, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_int, 0), null, @as(uint64, @bitCast(@as(c_long, @as(c_int, 0)))));
                    _ = &j;
                    while (true) {
                        if (!(j != null)) {
                            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 196), "%s", "test: j");
                            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 196), "allocation");
                            ctfailnow();
                        }
                        if (!false) break;
                    }
                    ...
                    while (true) {
                        if (!(r != 0)) {
                            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 198), "%s", "test: r");
                            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 198), "heapinsert");
                            ctfailnow();
                        }
                        if (!false) break;
                    }
            ...
            var j0: [*c]Job = @as([*c]Job, @ptrCast(@alignCast(heapremove(&h, @as(usize, @bitCast(@as(c_long, mid)))))));
            _ = &j0;
            while (true) {
                if (!(j0 != null)) {
                    ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 203), "%s", "test: j0");
                    ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 203), "j0 should not be NULL");
                    ctfailnow();
                }
                if (!false) break;
            }
            ...
            _ = &last_pri;
            {
                i = 1;
                while (i < n) : (i += 1) {
                    var j: [*c]Job = @as([*c]Job, @ptrCast(@alignCast(heapremove(&h, @as(usize, @bitCast(@as(c_long, @as(c_int, 0))))))));
                    _ = &j;
                    while (true) {
                        if (!(j.*.r.pri >= last_pri)) {
                            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 210), "%s", "test: j->r.pri >= last_pri");
                            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 210), "should come out in order");
                            ctfailnow();
                        }
                        if (!false) break;
                    }
                    ...
                    while (true) {
                        if (!(j != null)) {
                            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 212), "%s", "test: j");
                            ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 212), "j should not be NULL");
                            ctfailnow();
                        }
                        if (!false) break;
                    }
...
pub export fn ctbench_heap_insert(arg_n: c_int) void {
    var n = arg_n;
    _ = &n;
    var j: [*c][*c]Job = @as([*c][*c]Job, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, n))), @sizeOf([*c]Job)))));
    _ = &j;
    var i: c_int = undefined;
    _ = &i;
    {
        ...
        while (i < n) : (i += 1) {
            (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk j + @as(usize, @intCast(tmp)) else break :blk j - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).* = make_job_with_id(@as(uint, @bitCast(@as(c_int, 1))), @as(int64, @bitCast(@as(c_long, @as(c_int, 0)))), @as(int64, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_int, 0), null, @as(uint64, @bitCast(@as(c_long, @as(c_int, 0)))));
            while (true) {
                if (!((blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk j + @as(usize, @intCast(tmp)) else break :blk j - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).* != null)) {
                    ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 226), "%s", "test: j[i]");
                    ctfailnow();
                }
                if (!false) break;
            }
            (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk j + @as(usize, @intCast(tmp)) else break :blk j - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*.*.r.pri = @as(uint32, @bitCast(@as(c_uint, @truncate(-%(blk: {
                const tmp = i;
                if (tmp >= 0) break :blk j + @as(usize, @intCast(tmp)) else break :blk j - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*.*.r.id))));
        }
    ...
    ctresettimer();
    {
        i = 0;
        while (i < n) : (i += 1) {
            _ = heapinsert(&h, @as(?*anyopaque, @ptrCast((blk: {
                const tmp = i;
                if (tmp >= 0) break :blk j + @as(usize, @intCast(tmp)) else break :blk j - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*)));
        }
    ...
    ctstoptimer();
    {
        i = 0;
        while (i < n) : (i += 1) {
            job_free(@as([*c]Job, @ptrCast(@alignCast(heapremove(&h, @as(usize, @bitCast(@as(c_long, @as(c_int, 0)))))))));
        }
    }
    free(@as(?*anyopaque, @ptrCast(h.data)));
    free(@as(?*anyopaque, @ptrCast(j)));
}
pub export fn ctbench_heap_remove(arg_n: c_int) void {
    var n = arg_n;
    _ = &n;
    var h: Heap = Heap{
        .cap = @import("std").mem.zeroes(usize),
    ...
    _ = &i;
    {
        ...
        while (i < n) : (i += 1) {
            ...
            while (true) {
                if (!(j != null)) {
                    ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 256), "%s", "test: j");
                    ctlogpn("src/submodules/beanstalkd/testheap.c", @as(c_int, 256), "allocate job");
                    ctfailnow();
                }
                if (!false) break;
            }
    ...
    var jj: [*c][*c]Job = @as([*c][*c]Job, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, n))), @sizeOf([*c]Job)))));
    _ = &jj;
    ctresettimer();
    {
        i = 0;
        while (i < n) : (i += 1) {
            (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk jj + @as(usize, @intCast(tmp)) else break :blk jj - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).* = @as([*c]Job, @ptrCast(@alignCast(heapremove(&h, @as(usize, @bitCast(@as(c_long, @as(c_int, 0))))))));
        }
    }
    ctstoptimer();
    free(@as(?*anyopaque, @ptrCast(h.data)));
